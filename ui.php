...
?>
	<div id="major-publishing-actions">
		...
		<select name="settings[_]" id="workflow">
...
add_meta_box('save-category', __('Save','Shopp').$Admin->boxhelp('category-editor-save'), 'save_meta_box', 'shopp_page_shopp-importer-catmap', 'side', 'core');

function categories_meta_box ($EDGECategory) {
	$db =& DB::get();
	...
	// $EDGECategory->load_data(array('categories'));

	$selectedCategories = array();
	foreach ($EDGECategory->categories as $category) $selectedCategories[] = $category->id;
?>
<div id="category-menu" class="multiple-select short" style="height:400px !important">
	<ul>
...
add_meta_box(
	...
	'categories_meta_box',
	'shopp_page_shopp-importer-catmap',
	'side',
	'core'
);
...
//add_meta_box('category-settings', __('Settings','Shopp').$Admin->boxhelp('category-editor-settings'), 'settings_meta_box', 'shopp_page_shopp-importer-catmap', 'side', 'core');
...
add_meta_box('category-images', __('Category Images','Shopp').$Admin->boxhelp('category-editor-images'), 'images_meta_box', 'shopp_page_shopp-importer-catmap', 'normal', 'core');
...
add_meta_box('templates_menus', __('Product Templates &amp; Menus','Shopp').$Admin->boxhelp('category-editor-templates'), 'templates_meta_box', 'shopp_page_shopp-importer-catmap', 'advanced', 'core');
