...
jQuery(document).ready(function() {
    ...
    f("#addPriceLevel").click(function() {
        a()
    });
    f("#addDetail").click(function() {
        c()
    });
    f("#variations-setting").bind("toggleui",
    function() {
        if (this.checked) {
    ...
    function c(m) {
        var k = f("#details-menu"),
        n = f("#details-list"),
        g = f("#addDetailOption"),
        h = detailsidx,
        j = new NestedMenu(h, k, "specs", NEW_DETAIL_DEFAULT, m, {
            target: n,
            type: "list"
        });
        j.items = new Array();
